...
class TestTestsmokeTest():
  ...
  def test_test2HomePageSpotlightsandJoinFeature(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1919, 1372)
  ...
  def test_test4JoinPageDataEntry(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Bilbo")
    self.driver.find_element(By.NAME, "lname").send_keys("Baggins")
    self.driver.find_element(By.NAME, "bizname").send_keys("Middle-earth Maps & Books")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Elf-friend")
  ...
  def test_test5AdminPageUsernamePassword(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Gandalf")
